...
class Canvas(QtWidgets.QWidget):
    ...
    def setEpsilon(self, value):
        new_epsilon = self.epsilon + value
        if new_epsilon > 0:
    ...
    def endMove(self, copy=False):
        ...
        if copy:
            ...
            shape.line_color = self.selectedShape.line_color
            self.deleteSelected()
            self.shapes.append(shape)
        self.storeShapes()
        self.selectedShapeCopy = None
    ...
    def setLastLabel(self, text):
        ...
        print(self.shapes[-1].label)
        if text == '硬性渗出':
            self.shapes[-1].line_color = color_for_hard
        elif text == '软性渗出':
            self.shapes[-1].line_color = color_for_soft
        elif text == '视网膜出血':
            self.shapes[-1].line_color = color_for_hemo
        elif text == '微血管瘤':
            self.shapes[-1].line_color = color_for_micr
